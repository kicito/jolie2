...
interface ExtendedTimeServiceInterface {
    OneWay:
        nextXMins(int)(long)
}
...
service Time(){
    ...
    embed RandService{
        bindOut: Time -> timeService
    }

    inputPort IP {
		interfaces: ExtendedTimeService
        aggregates: TimeInterface
	}
    ...
    main{
        nextXMins(req)(res){
            ...
            res.param = TimerReq;
            scheduleTimeout@Time( TimerReq )( res )
        }
    }
}